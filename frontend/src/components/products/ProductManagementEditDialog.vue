        ...
        <div class="edit-section" style="margin-top: 10px;">
          ...
          <div class="section-body">
            <div class="purchase-cost-table-custom">
              ...
              <div class="table-cell cell-invoice-rate">
                <el-input
                  v-model="form.invoice_rate"
                  size="small"
                  placeholder="备注(如: 加收10%)"
...
.cell-invoice-rate { grid-column: 8; grid-row: 2; background-color: #e2efda !important; }

/* --- 行 3a & 3b (中间块 2 子行高度) --- */
/* 产品特性/选项/采购备注 - Col 1 (头), Col 2-4 (内容, 跨 row 3-4) */
.cell-product-detail-head { grid-column: 1; grid-row: 3 / 5; }
.cell-product-detail-content { grid-column: 2 / 5; grid-row: 3 / 5; justify-content: stretch; align-items: stretch; }

/* 采购方式 & 开票工厂 (Row 3 / 行 3a) */
.cell-purchase-option-head { grid-column: 5; grid-row: 3; }
.cell-purchase-option-content { grid-column: 6; grid-row: 3; }

.cell-factory-invoice-head { grid-column: 7; grid-row: 3; }
.cell-factory-invoice-content { grid-column: 8; grid-row: 3; }

/* 付款方式 & 货源地 (Row 4 / 行 3b) */
.cell-payment-method-head { grid-column: 5; grid-row: 4; }
.cell-payment-method-content { grid-column: 6; grid-row: 4; }

.cell-source-place-head { grid-column: 7; grid-row: 4; }
.cell-source-place-content { grid-column: 8; grid-row: 4; }
...
.cell-estimated-gross-weight-head { grid-column: 7 / 9; grid-row: 5; background-color: #d9d9d9 !important; font-weight: bold; }
...
.cell-estimated-gross-weight-content { grid-column: 7 / 9; grid-row: 6; background-color: #d9d9d9 !important; }
</style>
